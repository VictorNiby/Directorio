...
class historyModel extends Mysql{
    ...
    public function GetHistory($user_id){  
        $query = "SELECT servicio.id_servicio,servicio.titulo,servicio_imagenes.imagen_ref as imagen,servicio_usuario.total,servicio_usuario.fecha
        ...
        WHERE servicio_usuario.usuario_id = ? AND servicio_usuario.estado = 'Pagado'
        GROUP BY servicio.id_servicio,servicio_usuario.total DESC";
